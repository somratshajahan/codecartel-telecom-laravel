...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('homepage_settings', function (Blueprint $table) {
            $table->string('mail_mailer')->default('smtp')->after('social_messenger_url');
    ...
    {
        Schema::table('homepage_settings', function (Blueprint $table) {
            $table->dropColumn(['mail_mailer', 'mail_host', 'mail_port', 'mail_username', 'mail_password', 'mail_encryption', 'mail_from_address', 'mail_from_name']);
        });
    }
};
