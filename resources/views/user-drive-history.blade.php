    ...
    <div class="drawer lg:drawer-open">
                ...
                <div class="mx-auto w-full max-w-6xl">
                    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-6">
                        <div>
                            ...
                            <p class="text-base-content/60">Drive এবং related internet history এখানে দেখানো হচ্ছে।</p>
                        </div>
        ...
        <div class="drawer-side">
            ...
            <ul class="menu p-4 w-60 min-h-full bg-base-100 text-base-content">
                ...
                @if($canAddBalance)
                <li><a href="{{ route('user.add.balance') }}"><svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                        </svg>Add Balance</a></li>
                @endif
                ...
                <li><a href="{{ route('user.pending.requests') }}"><svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li>
                    <details open>
                        ...
                        <ul class="p-2">
                            ...
                            <li><a href="{{ route('user.all.history', ['type' => 'internet']) }}">Internet Pack</a></li>
                            @endif
                            @if($canDriveHistory)
                            <li><a class="{{ $activeHistoryType === 'drive' ? 'active bg-primary text-primary-content' : '' }}" href="{{ route('user.drive.history') }}">Drive</a></li>
                            @endif
                            <li><a href="#">Islami Bank</a></li>
                        </ul>
                    </details>
