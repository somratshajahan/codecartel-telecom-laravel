...
<head>
    ...
    <style>
        ...
        .youtube:hover { background-color: #FF0000; color: white; }
        .shopee:hover { background-color: #FF5722; color: white; }
        .telegram:hover { background-color: #0088CC; color: white; }
        .messenger:hover { background-color: #0084FF; color: white; }
    </style>
</head>
                    ...
                    <div class="operator-card card bg-base-100 shadow-xl transition-all duration-300 cursor-pointer">
                        <div class="card-body items-center text-center p-6">
                            <div class="w-16 h-16 rounded-full flex items-center justify-center mb-3"
                                ...
                                @if($operator->logo_image_url)
                                    <img src="{{ $operator->logo_image_url }}" alt="{{ $operator->name }}" class="w-10 h-10 rounded-full object-contain bg-base-100">
                                @else
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="flex justify-center lg:justify-start gap-3 mt-6">
                        ...
                        <a href="{{ optional($settings)->social_youtube_url ?? 'https://youtube.com/@codecartel' }}" target="_blank" class="btn btn-circle btn-sm bg-[#FF0000] text-white border-none hover:bg-[#FF0000]/80">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                        </a>
                        <a href="{{ optional($settings)->social_shopee_url ?? 'https://shopee.com/codecartel' }}" target="_blank" class="btn btn-circle btn-sm bg-[#FF5722] text-white border-none hover:bg-[#FF5722]/80">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M16.925 3.735a2.992 2.992 0 0 1 2.084-.846h2.205a3.022 3.022 0 0 1 2.108 3.022v2.46l-.585-.293a1.142 1.142 0 0 0-.683-.195H3.332a2.05 2.05 0 0 0-1.877 1.059L0 12.451v.049l.797.398a2.95 2.95 0 0 1 1.476.977l7.235 3.618a2.965 2.965 0 0 1 .88 1.304v2.166a3.022 3.022 0 0 1-3.022 3.022h-2.46a3.022 3.022 0 0 1-3.022-3.022v-2.048l-.366.122a1.142 1.142 0 0 0-.586.512l-2.47 4.94h3.608l7.195-3.584 1.367-2.813a2.992 2.992 0 0 1-.146-1.134V6.926a3.022 3.022 0 0 1-.195-2.955v-.098l3.178 1.583v-2.46l-1.465-.733a.978.978 0 0 0-.635-.195h-5.74l-1.221-2.033h2.704z"/></svg>
                        </a>
                        <a href="{{ optional($settings)->social_telegram_url ?? 'https://t.me/codecartel' }}" target="_blank" class="btn btn-circle btn-sm bg-[#0088CC] text-white border-none hover:bg-[#0088CC]/80">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z"/></svg>
                        </a>
