            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.login') }}" method="POST">
                    ...
                    <div class="form-control">
                        ...
                        <input type="email" name="email" placeholder="admin@codecartel.com" class="input input-bordered w-full @error('email') input-error @enderror" value="{{ old('email') }}" required />
                    </div>
