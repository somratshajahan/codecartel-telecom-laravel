    ...
    <div class="drawer lg:drawer-open">
        ...
        <div class="drawer-content flex flex-col">
            ...
            <div class="p-6 bg-base-200">
                <div class="max-w-md mx-auto bg-base-100 p-6 rounded-lg shadow-md">
                    <h2 class="text-2xl font-bold mb-6 text-center text-base-content">Transfer Balance</h2>
                    ...
                    <form id="transferForm">
                        @csrf
                        <div class="mb-4">
                            <label class="block text-sm font-bold mb-2" for="receiver_username">
                                Receiver Username
                            </label>
                            <input 
                                type="text" 
                        ...
                        <div class="mb-4">
                            <label class="block text-sm font-bold mb-2" for="transfer_type">
                        ...
                        <div class="mb-4">
                            <label class="block text-sm font-bold mb-2" for="balance_display">
                                Available Balance
                            </label>
                            <input 
                                type="text" 
                        ...
                        <div class="mb-4">
                            <label class="block text-sm font-bold mb-2" for="amount">
                                Amount to Transfer
                            </label>
                            <input 
                                type="number" 
                        ...
                        <div class="mb-4">
                            <label class="block text-sm font-bold mb-2" for="pin">
                                Security PIN
                            </label>
                            <input 
                                type="password" 
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('transferForm').addEventListener('submit', function(e) {
                ...
                const availableBalance = parseFloat(balanceDisplay.value);
                ...
                fetch('{{ route("balance.transfer.store") }}', {
                    method: 'POST',
                    body: formData,
                    headers: {
                ...
                .then(data => {
                    if(data.success) {
                        ...
                        window.location.href = '{{ route("balance.transfer.index") }}';
                    } else {
            ...
            loadBalanceByType(transferTypeSelect.value || 'main');
        });
    </script>
</body>
</html>