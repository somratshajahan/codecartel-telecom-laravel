                    ...
                    <li>
                        <details>
                            ...
                            <ul>
                                ...
                                <li><a href="{{ route('admin.manage.admins') }}" class="active">Manage Admin Users</a></li>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="space-y-2 max-h-96 overflow-y-auto">
                            ...
                            <div class="form-control">
                                <label class="label cursor-pointer justify-start gap-2">
                                    <input type="checkbox" name="permissions[]" value="manage_resellers" class="checkbox checkbox-primary checkbox-sm permission-checkbox" />
                                    <span class="label-text">Manage Resellers</span>
                                </label>
                            </div>
                            <div class="form-control">
                                <label class="label cursor-pointer justify-start gap-2">
