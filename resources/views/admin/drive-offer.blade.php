...
<head>
    ...
    <title>{{ optional($settings)->page_title ?? 'Drive Offer' }} - {{ optional($settings)->company_name ?? 'Codecartel Telecom' }}</title>
...
<body class="min-h-screen bg-base-200">
    ...
    <div class="navbar bg-base-100 shadow-md sticky top-0 z-50">
        ...
        <div class="flex-1">
            <a href="{{ route('admin.dashboard') }}" class="text-xl font-bold px-2 hover:text-primary transition-colors">{{ optional($settings)->company_name ?? 'Codecartel Telecom' }} - Drive Offer</a>
        </div>
                            ...
                            <table class="table table-zebra w-full">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.manage.drive.package', ['operator' => $drive['operator']]) }}" class="btn btn-sm btn-info">Manage</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    @else
