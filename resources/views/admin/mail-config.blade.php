        ...
        <div class="drawer-side z-40">
            ...
            <aside id="sidebar" class="bg-base-100 w-64 min-h-screen border-r border-base-200">
                ...
                <ul class="menu p-4 gap-1">
                    ...
                    <li><a href="{{ route('admin.backup') }}"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <li>
                        <details open>
                            <summary><svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                </svg><span class="sidebar-text">Settings</span></summary>
                            <ul>
                                <li><a href="{{ route('admin.homepage.edit') }}">General Settings</a></li>
                                <li><a href="{{ route('admin.mail.config') }}" class="active">Mail Configuration</a></li>
