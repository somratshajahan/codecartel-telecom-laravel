...
<head>
    ...
    <title>{{ optional($settings)->page_title ?? 'Manage Regular Package' }} - {{ optional($settings)->company_name ?? 'Codecartel Telecom' }}</title>
...
<body class="min-h-screen bg-base-200">
    <div class="drawer lg:drawer-open">
        ...
        <div class="drawer-content flex flex-col">
            ...
            <div class="navbar bg-base-100 shadow-md sticky top-0 z-30">
                ...
                <div class="flex-1"><a href="{{ route('admin.dashboard') }}" class="text-xl font-bold px-2 hover:text-primary transition-colors">{{ optional($settings)->company_name ?? 'Codecartel Telecom' }} - Manage Regular Package ({{ $operator }})</a></div>
            ...
            <!-- Main Content -->
            <div class="p-6">
                <h1 class="text-3xl font-bold mb-6">Manage Regular Package - {{ $operator }}</h1>

                <!-- Search -->
                <div class="card bg-base-100 shadow-xl mb-6">
                    <div class="card-body">
                        <h3 class="text-lg font-bold mb-4">Search</h3>
                        <form method="GET" action="{{ route('admin.manage.regular.package', ['operator' => $operator]) }}">
                        ...
                        <form method="POST" action="{{ route('admin.manage.regular.package.update', ['operator' => $operator]) }}" class="mt-2">
                            @csrf
    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('admin.manage.regular.package.store', ['operator' => $operator]) }}">
            @csrf
                                ...
                                <tbody>
                                    @forelse($packages ?? [] as $package)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.manage.regular.package.edit', ['operator' => $package->operator, 'id' => $package->id]) }}" class="btn btn-sm btn-warning">Edit</a>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
        ...
        <div class="drawer-side z-40 overflow-y-auto">
            ...
            <aside id="sidebar" class="bg-base-100 w-64 h-screen border-r border-base-200 transition-all duration-300 overflow-y-auto">
                ...
                <ul class="menu p-4 gap-1">
                    ...
                    <li><details><summary><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>Recharge History</summary><ul><li><a href="{{ route('admin.all.history') }}">All History</a></li><li><a>Flexiload</a></li><li><a href="{{ route('admin.drive.history') }}">Drive</a></li><li><a>Internet Pack</a></li><li><a>Bkash</a></li><li><a>Nagad</a></li><li><a>Rocket</a></li><li><a>Success Refund</a></li><li><a>Islami Bank</a></li></ul></details></li>
                    ...
                    <li><details open><summary><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4" /></svg>Offer Settings</summary><ul><li><a href="{{ route('admin.regular.offer') }}">Regular Package</a></li><li><a href="{{ route('admin.drive.offer') }}">Drive Package</a></li></ul></details></li>
