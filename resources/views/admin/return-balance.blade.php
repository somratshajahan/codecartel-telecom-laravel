...
<body class="min-h-screen bg-base-200 flex items-center justify-center">
    <div class="container mx-auto p-6 max-w-2xl">
        <div class="card bg-base-100 shadow-2xl">
            <div class="card-body">
                <h2 class="card-title text-3xl mb-6 text-center">Return Balance</h2>
                ...
                <form method="POST" action="{{ route('admin.store.return.balance', $user->id) }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="form-control">
                            ...
                            <input type="number" name="amount" step="0.01" min="0.01" class="input input-bordered" placeholder="Enter amount to return" required />
                        </div>
                    </div>
