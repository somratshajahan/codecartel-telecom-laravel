...
<head>
    ...
    <title>Return Balance - {{ optional($settings)->company_name ?? 'Codecartel Telecom' }}</title>
        ...
        <div class="card bg-base-100 shadow-2xl">
            <div class="card-body">
                <div class="flex flex-col gap-3 mb-6 md:flex-row md:items-center md:justify-between">
                    <h2 class="card-title text-3xl">Return Balance</h2>
                    <div class="flex gap-2">
                        <a href="{{ route('admin.add.balance', $user->id) }}" class="btn btn-outline btn-primary btn-sm">Add Balance</a>
                        <span class="btn btn-error btn-sm pointer-events-none">Return Balance</span>
                    </div>
                </div>
                ...
                <form method="POST" action="{{ route('admin.store.return.balance', $user->id) }}">
                    @csrf
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="form-control">
                            ...
                            <input type="number" name="amount" value="{{ old('amount') }}" step="0.01" min="0.01" class="input input-bordered" placeholder="Enter amount to return" required />
                        </div>
                        ...
                        <div class="form-control md:col-span-2">
                            ...
                            <textarea name="description" rows="3" class="textarea textarea-bordered" placeholder="Why are you returning this balance?">{{ old('description') }}</textarea>
                        </div>
                    ...
                    <div class="flex gap-4 mt-6">
                        <button type="submit" class="btn btn-error flex-1">Return Balance</button>
