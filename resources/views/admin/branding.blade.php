    ...
    <div class="drawer lg:drawer-open">
        ...
        <div class="drawer-content flex flex-col p-6">
            ...
            <div class="card bg-base-100 shadow-xl">
                <div class="card-body">
                    <form id="brandingForm" action="{{ route('admin.branding.update') }}" method="POST" class="space-y-8">
                        @csrf
                        ...
                        <section>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div class="form-control">
                                    ...
                                    <input type="text" name="brand_name" class="input input-bordered w-full" placeholder="e.g. MyBrand" />
                                </div>
                                <div class="form-control">
                                    <label class="label"><span class="label-text font-bold">Top Title</span></label>
                                    <input type="text" name="top_title" class="input input-bordered w-full" placeholder="e.g. Welcome to Admin" />
                                </div>
                                <div class="form-control">
                                    <label class="label"><span class="label-text font-bold">Footer</span></label>
                                    <input type="text" name="footer" class="input input-bordered w-full" placeholder="e.g. © 2024 All Rights Reserved" />
                                </div>
                            </div>
                        </section>
                        ...
                        <section class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="form-control">
                                ...
                                <select name="sms_provider" class="select select-bordered w-full">
                                    <option disabled selected>Select Sms Provider</option>
                                    <option>Solutionsclan</option>
                                    <option>Flexisoftwarebd</option>
                            ...
                            <div class="form-control">
                                ...
                                <input type="text" name="sms_user" class="input input-bordered w-full" />
                            </div>
                            <div class="form-control">
                        ...
                        <section id="payment-gateway" class="grid grid-cols-1 md:grid-cols-4 gap-4 scroll-mt-24">
                            <div class="form-control">
                                ...
                                <input type="text" name="bkash" class="input input-bordered input-sm" />
                            </div>
                            <div class="form-control">
                                <label class="label"><span class="label-text font-bold">Rocket</span></label>
                                <input type="text" name="rocket" class="input input-bordered input-sm" />
                            </div>
                            <div class="form-control">
                                <label class="label"><span class="label-text font-bold">Nagad</span></label>
                                <input type="text" name="nagad" class="input input-bordered input-sm" />
                            </div>
                            <div class="form-control">
                                <label class="label"><span class="label-text font-bold">Upay</span></label>
                                <input type="text" name="upay" class="input input-bordered input-sm" />
                            </div>
                        </section>
                        ...
                        <section class="grid grid-cols-2 md:grid-cols-4 gap-4">
                            @for($i=1; $i<=4; $i++)
                                <div class="form-control">
                                <label class="label"><span class="label-text">Image-{{$i}} Link</span></label>
                                <input type="text" name="image_{{$i}}" class="input input-bordered input-xs" />
                </div>
                @endfor
                </section>
                ...
                <section class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="form-control">
                        ...
                        <textarea name="keywords" class="textarea textarea-bordered h-24"></textarea>
                    </div>
                </section>
                </form>
            </div>
