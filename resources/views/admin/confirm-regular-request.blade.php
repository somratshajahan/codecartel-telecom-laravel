...
<head>
    ...
    <title>Confirm Regular Request - {{ optional($settings)->company_name ?? 'Codecartel Telecom' }}</title>
...
<body class="min-h-screen bg-base-200 flex items-center justify-center">
    <div class="container mx-auto p-6 max-w-2xl">
        <div class="card bg-base-100 shadow-2xl">
            <div class="card-body">
                <h2 class="card-title text-3xl mb-6 text-center justify-center">Confirm Regular Request</h2>
                ...
                <form method="POST" action="/admin/regular-requests/{{ $request->id }}/confirm">
                    @csrf
