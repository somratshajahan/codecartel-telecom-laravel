...
<body class="min-h-screen bg-base-200 flex items-center justify-center">
    <div class="container mx-auto p-6 max-w-2xl">
        <div class="card bg-base-100 shadow-2xl">
            <div class="card-body">
                <h2 class="card-title text-3xl mb-6 text-center justify-center">Confirm {{ $request->method }} Balance Request</h2>
                ...
                <form method="POST" action="/admin/manual-payment-requests/{{ $request->id }}/confirm">
                    ...
                    <div class="form-control mb-4">
                        ...
                        <textarea name="admin_note" class="textarea textarea-bordered" placeholder="Optional approval note">{{ old('admin_note', $request->admin_note) }}</textarea>
