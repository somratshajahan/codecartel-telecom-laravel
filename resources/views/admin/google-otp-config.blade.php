                        ...
                        <div class="card-body space-y-6">
                            <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                                <div>
                                    ...
                                    <p class="text-sm opacity-70">Google Authenticator setup/login flow-এর global access এখান থেকে manage করুন।</p>
                                </div>
                    ...
                    <li>
                        <details open>
                            ...
                            <ul>
                                ...
                                <li><a href="{{ route('admin.google.otp.config') }}" class="active">Google OTP</a></li>
