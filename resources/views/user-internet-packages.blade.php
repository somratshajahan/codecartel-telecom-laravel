...
<head>
    ...
    <title>{{ optional($settings)->page_title ?? 'Internet Packages' }} - {{ optional($settings)->company_name ?? 'Codecartel Telecom' }}</title>
    ...
    <div class="drawer lg:drawer-open">
        ...
        <div class="drawer-content flex flex-col">
            <div class="navbar bg-base-100 shadow-md sticky top-0 z-30">
                ...
                <div class="flex-none gap-2">
                    <a href="{{ route('user.internet') }}" class="btn btn-ghost btn-sm">
            ...
            <div class="container mx-auto p-6 flex-1">
                <h1 class="text-3xl font-bold mb-6">{{ $operator }} Internet Packages</h1>
                            ...
                            <div class="card bg-base-100 shadow-xl hover:shadow-2xl transition-shadow">
                                <div class="card-body">
                                    ...
                                    <div class="flex justify-between items-center text-sm">
                                        <span>Expires:</span>
                                        <span>{{ \Carbon\Carbon::parse($package->expire)->format('d M Y') }}</span>
                                    </div>
                                    <div class="card-actions justify-end mt-4">
                                        <a href="{{ route('user.internet.buy', ['operator' => $operator, 'package' => $package->id]) }}" class="btn btn-primary btn-sm">Buy</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                ...
                @else
                    <div class="alert alert-info">
                        ...
                        <span>No active internet packages available for {{ $operator }} at the moment.</span>
                    </div>
                @endif
            </div>
        ...
        <div class="drawer-side">
            ...
            <ul class="menu p-4 w-60 min-h-full bg-base-100 text-base-content">
                ...
                <li><details><summary><span class="flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" /></svg>New Request</span></summary><ul class="p-2"><li><a href="#">Flexiload</a></li><li><a href="{{ route('user.internet') }}">Internet Pack</a></li><li><a href="{{ route('user.drive') }}">Drive</a></li><li><a href="#">Bkash</a></li><li><a href="#">Nagad</a></li><li><a href="#">Rocket</a></li><li><a href="#">Upay</a></li><li><a href="#">Islami Bank</a></li><li><a href="#">Bulk Flexi</a></li></ul></details></li>
