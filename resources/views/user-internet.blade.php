...
<head>
    ...
    <title>{{ optional($settings)->page_title ?? 'Internet Offers' }} - {{ optional($settings)->company_name ?? 'Codecartel Telecom' }}</title>
    ...
    <div class="drawer drawer-open">
        ...
        <div class="drawer-content flex flex-col">
            ...
            <div class="container mx-auto p-6 flex-1">
                <h1 class="text-3xl font-bold mb-6">Select Operator (Internet Pack)</h1>
                        ...
                        <table class="table table-zebra w-full">
                            ...
                            <tbody>
                                @foreach(array_slice($operators, 0, 3) as $operator)
                                    <tr>
                                        <td>
                                            <a href="{{ route('user.internet.packages', ['operator' => $operator['name']]) }}" class="flex items-center gap-3 hover:bg-base-200 p-2 rounded-lg transition-all">
