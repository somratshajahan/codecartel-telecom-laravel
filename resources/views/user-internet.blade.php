            ...
            <div class="container mx-auto p-6 flex-1">
                <div class="max-w-6xl mx-auto">
                    <div class="mb-10 text-center">
                        <h1 class="text-3xl lg:text-4xl font-extrabold text-slate-800">Select Operator (Internet Pack)</h1>
                    ...
                    <div class="grid grid-cols-2 lg:grid-cols-3 gap-4 max-w-5xl mx-auto">
                        ...
                        @endphp
                        <a href="{{ route('user.internet.packages', ['operator' => $operatorRouteName]) }}"
